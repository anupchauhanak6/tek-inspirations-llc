...
const services = [
  ...
  },
  {
    ...
    title: "RPO Solutions",
    subtitle:
      "Elite talent acquisition tailored to your specific technical needs.",
    ...
    <section className="py-24 md:py-32 bg-[#0a0a0a] font-sans border-b border-white/10 relative z-10 overflow-hidden">
      ...
      <div className="max-w-[1700px] mx-auto px-6 lg:px-16 relative z-20">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
          ...
          >
            <h4
              className="font-black tracking-[0.2em] uppercase text-[11px] mb-5 flex items-center gap-4"
              style={{ color: BRAND }}
            >
            ...
            <div
              className="w-20 h-1 rounded-none mb-6"
              style={{ background: BRAND }}
            />
            <p className="text-white/50 text-lg md:text-xl font-medium max-w-xl">
              From deploying scalable codebases to acquiring the top 1% of
              global tech talent, we provide unified operational dominance.
            </p>
          </motion.div>
          ...
          >
            ...
            >
              <span
                className="font-black tracking-widest uppercase text-sm md:text-lg border-b-[3px] border-white pb-1 transition-all"
              ...
              <svg
                ...
                viewBox="0 0 44 26"
                fill="none"
                className="transition-colors group-hover:translate-x-2 duration-300"
                style={{ color: BRAND }}
              >
                <path
                  d="M2,2 L2,13 L40,13"
          ...
          {services.map((service, i) => (
            ...
            >
              ...
              <div className="absolute top-52 left-8 z-20">
                <div
                  className="w-16 h-16 bg-[#0a0a0a] flex items-center justify-center border border-white/20 group-hover:border-white/50 transition-all duration-500 shadow-2xl"
                  style={{ color: BRAND }}
                >
              ...
              <div
                className="p-8 pt-12 flex flex-col flex-1 pl-8 border-l-[3px] border-transparent transition-colors duration-300"
                style={{ borderLeftColor: `rgba(40,148,52,0)` }}
              >
                ...
                `}</style>
                <div
                  className={`hover-border-${i} absolute top-64 bottom-0 left-0 w-[4px] bg-transparent transition-colors duration-500`}
                />
                ...
                <ul className="space-y-4 mb-10 flex-1">
                  {service.list.map((item, idx) => (
                    <li key={idx} className="flex items-start gap-4">
                      ...
                      <span className="text-white/70 font-bold text-[13px] uppercase tracking-wide">
                        {item}
                      </span>
                    </li>
                  ))}
