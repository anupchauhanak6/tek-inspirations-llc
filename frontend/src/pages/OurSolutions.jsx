          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8 items-center">
            ...
            >
              ...
              <h2 className="text-4xl lg:text-7xl font-black uppercase tracking-tighter mb-8 leading-[0.95] text-zinc-900">
                Flawless Execution,
                <br />
                <span style={{ color: BRAND }}>Zero Compromise</span>
              </h2>
              <div
                className="space-y-6 text-zinc-600 leading-relaxed text-lg font-bold border-l-[3px] mb-12 pl-6 shadow-sm"
              ...
              <Link
                to="/contact"
                className="group flex items-center gap-4 text-zinc-900 hover:text-zinc-600 transition-colors relative z-10 w-fit"
              >
                <span
                  className="font-black tracking-[0.2em] uppercase text-[13px] border-b-[3px] border-zinc-300 pb-1.5 transition-all group-hover:border-zinc-900"
        ...
        <div className="max-w-[1700px] mx-auto px-6 lg:px-16 relative z-10">
          <div className="flex flex-col md:flex-row gap-12 items-end justify-between mb-20 border-b border-white/10 pb-8">
            ...
            <p className="text-white/40 max-w-sm text-sm font-bold leading-relaxed pb-2">
              End-to-end technology and personnel frameworks required to heavily
              scale modern architectures.
            </p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-12 gap-px bg-white/10 border border-white/10 shadow-2xl">
            {services.map(
              ({ title, path, icon: Icon, size, img, desc, tags }, i) => (
                <motion.div
                  key={title}
                  initial={{ opacity: 0 }}
