...
import { CheckCircle2, Lightbulb, Target, Map, BarChart3, ArrowRight, GitMerge, Settings2, Cpu } from "lucide-react";
...
const process = [
  { step: "INFRA.SCAN", icon: Target,   title: "Diagnostic Phase",       desc: "Comprehensive auditing of current tech stack, uncovering vulnerabilities and resource bottlenecks." },
  { step: "SYS.DESIGN", icon: Map,      title: "Architecture Strategy",  desc: "Developing a highly scalable, ISO-compliant blueprint bridging modern SaaS with internal workflows." },
  { step: "DEV.DEPLOY", icon: GitMerge, title: "Agile Deployment",       desc: "Executing phased rollouts with zero operational downtime and robust CI/CD integration." },
  { step: "OPS.MONIT",  icon: Settings2,title: "Optimization Loop",      desc: "Real-time telemetry and iterative refining to exceed predefined Key Performance Indicators." },
];
                ...
                <ul className="space-y-5">
                  {deliverables.map((d, i) => (
                    <li key={i} className="flex items-start gap-4">
                      <div className="mt-0.5 w-6 h-6 rounded bg-[#088349]/20 border border-[#088349]/40 flex items-center justify-center shrink-0">
      ...
      <section className="py-24 bg-[#0f172a] relative border-t border-slate-800">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {process.map(({ step, icon: Icon, title, desc }, i) => (
              <motion.div key={step}
                ...
                <div className="absolute inset-0 bg-gradient-to-b from-transparent via-[#088349]/10 to-transparent h-[200%] -translate-y-[100%] group-hover:translate-y-[100%] transition-transform duration-1000 ease-in-out pointer-events-none" />
          ...
          <div className="text-center mt-16">
            <Link to="/contact" className="inline-flex items-center gap-2 px-8 py-4 bg-[#088349] hover:bg-[#0aad60] text-white font-bold text-sm rounded-xl transition-all duration-300 shadow-xl shadow-[#088349]/30 hover:-translate-y-0.5 group">
